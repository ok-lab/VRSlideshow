...
public class FingerSync : MonoBehaviour, IPunObservable
{
    #region photon 
    ...
    #region Oculus Finger variables
    ...
    //自分のアバターに対してプレイや０の入力を受け付ける
    void InputOVRControl()
    {
        ...
        else
        {
            ...
            {   //  y  switch z
                ...
                case FingerType.L_Index:
                    ...
                    axis = new Vector3(0.1f, 0, 0.8f); //  y  switch z
                ...
                case FingerType.R_Thumb:
                    ...
                    touchButtonPool.Add(OVRInput.RawTouch.B);
                    trigger = OVRInput.RawAxis1D.RHandTrigger;
                    axis = new Vector3(0.1f, 0.4f, 0.5f);
                    isThumb = true;
                    break;
                case FingerType.R_Index:
                    trigger = OVRInput.RawAxis1D.RIndexTrigger;
